...
download_file "https://github.com/openssl/openssl/archive/OpenSSL_$OPENSSL_VERSION.tar.gz" | tar -zx >> "$DIR/install.log" 2>&1
echo "open ssl downloaded"
mv openssl-OpenSSL_$OPENSSL_VERSION openssl
echo "open ssl moved"
